                        ...
                        <div class="order-detail">
                            <div class="table-responsive">
                                <table class="table " style="width:100%">
                                    ...
                                    <thead>
                                    <tr>
                                        <th scope="col" class="h-top" style="text-align: left;"><strong>{{translate('Order No:')}}</strong></th>
                                        <th scope="col" class="h-top" style="text-align: left;"><strong>{{translate('Payment :')}}</strong></th>
                                        <th scope="col" class="h-top" style="text-align: left;"><strong>{{translate('Payment Status:')}}</strong>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
