    ...
    <div class="container-fluid" style="background: #fff;">
        ...
        <div class="main-header-center">
            <div class="responsive-logo">
                <a href="{{route('home')}}"><img src="{{getShortIconFromConfig()}}" class="mobile-logo"
                                                 alt="logo" width="36" height="26"></a>
                <a href="{{route('home')}}"><img src="{{getShortIconFromConfig()}}" class="mobile-logo-dark"
                                                 alt="logo" width="36" height="26"></a>
            </div>
        </div>
        <div class="main-header-right">
            ...
            <div class="dropdown d-md-flex">
                <a class="nav-link icon full-screen-link" href="">
                    <em class="fe fe-maximize fullscreen-button fullscreen header-icons"></em>
                    <em class="fe fe-minimize fullscreen-button exit-fullscreen header-icons"></em>
                </a>
            </div>
            <div class="dropdown main-profile-menu">
                <a class="d-flex" href="">
                    <span class="main-img-user">
                        <img alt="avatar"
                             src="{{asset('images/avatar.png')}}"></span>
                </a>
                <div class="dropdown-menu">
                    <div class="header-navheading">
                        <h6 class="main-notification-title">{{Auth::user()->name ?? 'N/A'}}</h6>
                        <p class="main-notification-text">{{Auth::user()->username ?? 'N/A'}}({{'Admin'}}
                            )</p>
                    </div>
                    <a class="dropdown-item border-top" href="{{ route('profile') }}">
                        <em class="fe fe-user"></em>&nbsp; My Profile
                    </a>
                    <a class="dropdown-item" href="{{ route('profile') }}">
                        <em class="fe fe-edit"></em>&nbsp; Edit Profile
                    </a>

                    <a class="dropdown-item" href="{{route('logout')}}">
                        <em class="fe fe-power"></em>&nbsp; Logout
                    </a>
                </div>
            </div>
        </div>
